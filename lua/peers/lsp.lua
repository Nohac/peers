...
local DELETE_THREAD_METHOD = "peers/deleteThread"
...
local COMMAND_DELETE_THREAD = "peers.deleteThread"
...
local COMMAND_HANDLERS = {
  ...
  [COMMAND_DELETE_THREAD] = "delete_thread",
...
local MUTATION_METHODS = {
  ...
  delete_thread = DELETE_THREAD_METHOD,
